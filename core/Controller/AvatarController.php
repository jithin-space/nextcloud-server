...
class AvatarController extends Controller {
	 ...
	 */
	#[Route(Route::TYPE_INDEX, verb: 'GET', url: '/avatar/{userId}/{size}/dark')]
	 ...
	 * 404: Avatar not found
	 */
	#[Route(Route::TYPE_INDEX, verb: 'GET', url: '/avatar/{userId}/{size}')]
	 ...
	 * @NoAdminRequired
	 */
	#[Route(Route::TYPE_INDEX, verb: 'POST', url: '/avatar/')]
	 ...
	 * @NoAdminRequired
	 */
	#[Route(Route::TYPE_INDEX, verb: 'DELETE', url: '/avatar/')]
	 ...
	 */
	#[Route(Route::TYPE_INDEX, verb: 'GET', url: '/avatar/tmp')]
	 ...
	 * @NoAdminRequired
	 */
	#[Route(Route::TYPE_INDEX, verb: 'POST', url: '/avatar/cropped')]
